...
Dynamai is a fundamental machine learning (funML) research lab built on applied and computational mathematics. We focus on problems at the interface of applied probability, dynamical systems, and ML. Our broader vision is to shape the next generation of ML through mathematical insight, principled modeling, and rigorous methodology. Our research spans **generative modeling**, **sequence modeling**, **robustness and reliability in ML**, **ML for science**, and beyond. 
