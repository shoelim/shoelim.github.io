...
- **Generative modeling:** how can we understand and improve generative modeling methods based on dynamical measure transport, particularly for sequential data generated by dynamical systems
- **Sequence modeling:** how can we use ideas from ML and applied dynamical systems to model and learn sequential data, and to study the mathematical foundations of these approaches
- **Optimization and sampling:** how can we develop a deeper understanding of optimization and sampling algorithms in machine learning and improve them in principled ways
- **Robustness and reliability:** how can we leverage randomness to make ML systems safer, more robust, and more reliable
- **Scientific applications:** how can we develop principled mathematical frameworks for integrating scientific ML with domain knowledge 
